...
Elm.Flex = Elm.Flex || {};
Elm.Flex.make = function (_elm) {
   "use strict";
   _elm.Flex = _elm.Flex || {};
   if (_elm.Flex.values)
   return _elm.Flex.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   var start = Start;
   var VerticalReverse = {ctor: "VerticalReverse"};
   var verticalReverse = VerticalReverse;
   var HorizontalReverse = {ctor: "HorizontalReverse"};
   var horizontalReverse = HorizontalReverse;
   var Vertical = {ctor: "Vertical"};
   var vertical = Vertical;
   var Horizontal = {ctor: "Horizontal"};
   var horizontal = Horizontal;
   var layout = F4(function (direction,
   justify,
   align,
   wrap) {
      return function () {
         var wrapString = function () {
            switch (wrap.ctor)
         ...
         var alignString = function () {
            switch (align.ctor)
            {case "Center": return "center";
               case "End": return "flex-end";
               case "Start":
               return "flex-start";
               case "Stretch": return "strech";
               case "Surround":
               return "baseline";}
            _U.badCase($moduleName,
         ...
         var containerStyle = $Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                  ...
                                                                  ,{ctor: "_Tuple2"
                                                                   ,_0: "height"
                                                                   ,_1: "100%"}]));
         return $Html.div(_L.fromArray([containerStyle]));
      }();
   });
   var fullbleed = function (element) {
      return function () {
         var elementStyle = $Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                 ,_0: "width"
                                                                 ,_1: "100vw"}
                                                                ,{ctor: "_Tuple2"
                                                                 ,_0: "height"
                                                                ...
                                                                ,{ctor: "_Tuple2"
                                                                 ...
                                                                 ,_1: "flex"}]));
         return A2($Html.div,
         _L.fromArray([elementStyle]),
         _L.fromArray([element]));
      }();
   };
   var flexN = F2(function (factor,
   element) {
      return function () {
         var elementStyle = $Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                 ,_0: "flex"
                                                                 ,_1: A2($Basics._op["++"],
                                                                 $Basics.toString(factor),
                                                                 " 1 auto")}
                                                                ,{ctor: "_Tuple2"
                                                                 ,_0: "display"
                                                                 ,_1: "flex"}]));
   ...
   var flex = flexN(1);
   var container = function (direction) {
      return function () {
         var containerStyle = $Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                   ,_0: "display"
                                                                   ,_1: "flex"}
   ...
   var columnReverse = container("column-reverse");
   var row = container("row");
   var rowReverse = container("row-reverse");
   _elm.Flex.values = {_op: _op
                      ,container: container
                      ,column: column
...
Elm.Main.make = function (_elm) {
   ...
   var labels = A5($Flex.layout,
   $Flex.horizontal,
   $Flex.surround,
   $Flex.stretch,
   $Flex.noWrap,
   _L.fromArray([A5($Flex.layout,
                $Flex.vertical,
                $Flex.center,
                $Flex.center,
                $Flex.noWrap,
                _L.fromArray([label("I am on the left")]))
                ,A5($Flex.layout,
                $Flex.vertical,
                $Flex.surround,
                $Flex.center,
                $Flex.noWrap,
                _L.fromArray([label("I am on top")
                ...
                $Flex.center,
                $Flex.noWrap,
                _L.fromArray([label("I am on the right")]))]));
   var main = $Flex.fullbleed(labels);
   var background = function (color) {
      return function () {
         var backgroundStyle = $Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                    ,_0: "background-color"
                                                                    ,_1: color}
                                                                   ,{ctor: "_Tuple2"
                                                                    ,_0: "flex"
                                                                    ,_1: "1"}]));
         return A2($Html.div,
         _L.fromArray([backgroundStyle]),
         _L.fromArray([]));
      }();
   };
   var redBackground = background("red");
   var blueBackground = background("blue");
   var greenBackground = background("green");
   var blackBackground = background("black");
   var yellowBackground = background("yellow");
   var holyGrail = $Flex.column(_L.fromArray([redBackground
                                             ,A2($Flex.flexN,
                                             8,
                                             $Flex.row(_L.fromArray([blueBackground
                                                                    ,A2($Flex.flexN,
                                                                    4,
                                                                    greenBackground)
                                                                    ,yellowBackground])))
